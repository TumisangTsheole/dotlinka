...
<head>
  ...
  <style>
    ...
    .login-card {
      ...
      padding: 2rem; width: 100%; max-width: 400px; box-shadow: 0 2px 6px rgba(0,0,0,.05);
    }
    .login-card h1 { font-size: 22px; margin-bottom: 1.5rem; text-align: center; color: #1a1a1a; }
    ...
    .login-footer { text-align: center; margin-top: 1rem; font-size: 13px; color: #666; }
    .login-footer a { color: #D85A30; text-decoration: none; }
